...
//부모가 물려준 메소드 중에서 자식클래스에서 그 기능을 덮어쓰기함으로써 자식클래스의 독자적인 메소드를 정의해야하는 경우에 사용
//cf) 상속된 메소드와의 차이점: 상속->그랸 가져다 쓴다. 거기에 기능을 추가한다.
...
public class OverridingDemo {
	...
	public static void main(String[] args) {
		...
		//오버라이딩
		//메소드를 오버라이딩해주고, 이 메소드를 호출하게되면
		//부모클래스에 있는 메소드는 무시가 되고, 자식클래스가 가지고 있는 메소드가 실행됨
