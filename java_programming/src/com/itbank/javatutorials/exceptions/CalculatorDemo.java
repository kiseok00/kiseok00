...
class Calculator {
	...
	public void divide() {
		try {
			...
			//							at com.itbank.javatutorials.exceptions.Calculator.divide(CalculatorDemo.java:16)
		    //							at com.itbank.javatutorials.exceptions.CalculatorDemo.main(CalculatorDemo.java:36)
			
			
			
			//1.오류에 관한 기본적인 내용을 출력해줌. 상세하지 않음
			//2. 예외상황에 대한 좀 더 자세한 정보. ArithmeticException : 수학적인 계산 과정에서 발생하는 예외
			//3. 리턴값이 없음.가장 자세한 예외 정보를 제공
